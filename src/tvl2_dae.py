...
def tvl2_optical_flow_multiscale(I0, I1, u1, u2, tau, lam, theta, warps, epsilon, nscales=-1, zfactor=2):
    ...
    plt.show()
    plt.imsave('/mnt/data/OF/dae_guide_tvl2_' + str(lam) + "_warps_" + str(warps) + ".png", flow)
...
u1, u2 = tvl2_optical_flow_multiscale(I0, I1, np.zeros_like(I0), np.zeros_like(I0), tau=0.25, lam=0.6, theta=0.25, warps=35, nscales=5, epsilon=0.01)
