...
#####################################################################
#
# Partially adapted by Bastian Goldlücke (Universität Konstanz: bastian.goldluecke@uni-konstanz.de)
#
...
def read_disparity_crosshair(data_folder):
    ...
    params = read_parameters(data_folder)
    disparity_lf = np.zeros((params["num_cams_x"], params["num_cams_y"], params["height"], params["width"]),
                            dtype=np.float32)
